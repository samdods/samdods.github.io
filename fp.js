...
var te = {
    ...
    audio: function () {
        ...
        (a.threshold.value = -50), (a.knee.value = 40), (a.ratio.value = 12), (a.attack.value = 0), (a.release.value = 0.25), r.connect(a), a.connect(n.destination), r.start(0);
        var o = (function (e) {
                var t = 3,
                    n = 500,
                    r = 500,
    ...
    languages: function () {
        ...
        if ((void 0 !== r && n.push([r]), Array.isArray(t.languages)))
            (A() && g([!("MediaSettingsRange" in (e = window)), "RTCEncodedAudioFrame" in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3) || n.push(t.languages);
    ...
    platform: function () {
        ...
        return "MacIntel" === e && x() && !S()
            ? (function () {
                  ...
                  var e = screen,
                      t = e.width / e.height;
                  return g(["MediaSource" in window, !!Element.prototype.webkitRequestFullscreen, t > 0.65 && t < 1.53]) >= 2;
              })()
                ? "iPad"
                : "iPhone"
            : e;
...
function re(t) {
    return JSON.stringify(
        t,
        function (t, n) {
            return n instanceof Error ? e({ name: (r = n).name, message: r.message, stack: null === (a = r.stack) || void 0 === a ? void 0 : a.split("\n") }, r) : n;
            var r, a;
        },
        2
    );
